    ...
    <div className="font-display bg-[#EEF6F6] min-h-screen flex items-center justify-center p-4 antialiased text-[#19322F] relative overflow-hidden">
      ...
      <main className="w-full max-w-md z-10">
        <div className="text-center mb-10">
          <Link href="/" className="inline-flex items-center justify-center w-14 h-14 bg-[#006655] rounded-xl mb-6 shadow-[0_4px_20px_-2px_rgba(25,50,47,0.05)] text-white hover:opacity-90 transition-opacity">
        ...
        <div className="bg-white rounded-2xl shadow-[0_4px_20px_-2px_rgba(25,50,47,0.05)] p-8 sm:p-10 border border-white/50 backdrop-blur-sm">
          <div className="space-y-4">
            ...
            >
              ...
              <span className="relative z-10">{t('auth.continue_google')}</span>
            </button>
            ...
            >
              ...
              <span className="relative z-10">{t('auth.continue_github')}</span>
            </button>
          </div>

          <p className="mt-8 text-center text-sm text-[#19322F]/70">
            {t('auth.no_account')}{' '}
            <Link className="font-semibold text-[#006655] hover:text-[#004d40] transition-colors" href="#">
              {t('auth.sign_up')}
            </Link>
          </p>
        </div>
        ...
        <div className="mt-8 text-center">
          <nav className="flex justify-center gap-6 text-xs text-[#19322F]/50">
            <a className="hover:text-[#19322F] transition-colors" href="#">{t('auth.privacy')}</a>
            <a className="hover:text-[#19322F] transition-colors" href="#">{t('auth.terms')}</a>
            <a className="hover:text-[#19322F] transition-colors" href="#">{t('auth.help')}</a>
          </nav>
        </div>
      </main>
    </div>
